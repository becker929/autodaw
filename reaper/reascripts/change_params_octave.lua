-- change_params_octave.lua - Change specifically the octave parameter based on config
reaper.ShowConsoleMsg("change_params_octave.lua starting...\n")
...
function main()
    ...
    print("Changing octave parameter for FX: " .. fx_name)
    print("Target octave value: " .. target_value)

    -- Documentation file
    local timestamp = os.date("%Y%m%d_%H%M%S")
    local doc_file = io.open(output_dir .. "/octave_change_session" .. session_id .. "_" .. timestamp .. ".txt", "w")
    doc_file:write("Octave Parameter Change Log - Session " .. session_id .. "\n")
    doc_file:write("Timestamp: " .. os.date("%Y-%m-%d %H:%M:%S") .. "\n")
    doc_file:write("FX: " .. fx_name .. "\n")
    doc_file:write("Target octave value: " .. target_value .. "\n")
